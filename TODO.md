...
- [ ] **Termine bearbeitbar machen:** Termine müssen überall anklickbar + editierbar sein (auch vom Dashboard aus!). Detail-Modal/Seite mit: Titel ändern, Datum/Uhrzeit ändern, Info/Notizen hinzufügen, Ort ändern. Optional: Ideen/Skripte zum Termin verknüpfen (welche Videos sollen an dem Termin gedreht werden). Termin löschen.
